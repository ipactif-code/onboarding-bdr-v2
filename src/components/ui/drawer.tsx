...
function DrawerTrigger({
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Trigger>): ReactElement {
  return <DrawerPrimitive.Trigger data-slot="drawer-trigger" {...props} />
}

function DrawerPortal({
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Portal>): ReactElement {
  return <DrawerPrimitive.Portal data-slot="drawer-portal" {...props} />
}

function DrawerClose({
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Close>): ReactElement {
...
function DrawerOverlay({
  className,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Overlay>): ReactElement {
  return (
...
function DrawerContent({
  ...
  children,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Content>): ReactElement {
  return (
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">): ReactElement {
  return (
    <div
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">): ReactElement {
  return (
    <div
...
function DrawerTitle({
  className,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Title>): ReactElement {
  return (
...
function DrawerDescription({
  className,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Description>): ReactElement {
  return (
