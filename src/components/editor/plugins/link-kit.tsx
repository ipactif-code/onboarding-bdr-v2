...
import { getCursorOverlayElement } from '@/components/plate-ui/cursor-overlay';
...
export const useActiveLink = (): [MyLinkElement, number[]] | undefined => {
  ...
  return editingLinkEntry as [MyLinkElement, number[]] | undefined;
};
